...
public class RestServiceTest {
    ...
    public void setup() {
        ...
        pd1 = new PartitionDefinition(null, null, sh1.getIndex(), sh1.getName(), null);
        pd2 = new PartitionDefinition(null, null, sh2.getIndex(), sh2.getName(), null);
        pd3 = new PartitionDefinition(null, null, sh3.getIndex(), sh3.getName(), null);
        pd4 = new PartitionDefinition(null, null, sh4.getIndex(), sh4.getName(), null);
        pd5 = new PartitionDefinition(null, null, sh5.getIndex(), sh5.getName(), null);
        pd6 = new PartitionDefinition(null, null, sh6.getIndex(), sh6.getName(), null);
